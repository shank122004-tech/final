...
async function _generateQuizQuestions(exam, count, type) {
  ...
  const CF = global.CF = {
    ...
    _showGroupAdminGate() {
      ...
      el.innerHTML = `
        <div class="cf-form-card" style="text-align:center;padding:20px 16px;">
          ...
          <div style="font-size:15px;font-weight:800;color:var(--text-primary);margin-bottom:6px;">Group Admin Plan Required</div>
          <div style="font-size:12px;color:rgba(26,26,38,0.6);margin-bottom:14px;line-height:1.6;">
          ...
          <div style="display:flex;flex-direction:column;gap:8px;margin-bottom:14px;text-align:left;">
            <div style="background:rgba(16,185,129,0.08);border:1px solid rgba(16,185,129,0.25);border-radius:10px;padding:10px 12px;display:flex;justify-content:space-between;align-items:center;">
              <div>
                <div style="font-size:13px;font-weight:700;color:var(--text-primary);">👥 Group Leader</div>
                <div style="font-size:11px;color:rgba(26,26,38,0.70);">1 group · Members join FREE</div>
              </div>
            ...
            <div style="background:rgba(108,99,255,0.08);border:1px solid rgba(108,99,255,0.25);border-radius:10px;padding:10px 12px;display:flex;justify-content:space-between;align-items:center;">
              <div>
                <div style="font-size:13px;font-weight:700;color:var(--text-primary);">🎓 Coaching Starter</div>
                <div style="font-size:11px;color:rgba(26,26,38,0.70);">3 groups · Student dashboard</div>
              </div>
              <span style="font-size:15px;font-weight:800;color:#5b46d4;">₹499/mo</span>
            </div>
            <div style="background:rgba(245,158,11,0.07);border:1px solid rgba(245,158,11,0.25);border-radius:10px;padding:10px 12px;display:flex;justify-content:space-between;align-items:center;">
              <div>
                <div style="font-size:13px;font-weight:700;color:var(--text-primary);">🏫 Coaching Pro</div>
                <div style="font-size:11px;color:rgba(26,26,38,0.70);">Unlimited groups · Full analytics</div>
              </div>
    ...
    _showJoinGroup() {
      ...
      el.innerHTML = `
        <div class="cf-form-card">
          <div style="font-size:13px;font-weight:700;color:var(--text-primary);margin-bottom:4px;">🔗 Join a Study Group</div>
          <div style="font-size:11px;color:rgba(26,26,38,0.70);margin-bottom:10px;">Get the invite code from your group admin. Joining is <strong style="color:#4ade80;">completely FREE</strong>!</div>
